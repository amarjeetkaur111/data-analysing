...
<div class="card card-cascade cascading-admin-card">
  ...
  <div class="admin-up">
    ...
    <div class="data">
      <p class="text-uppercase">Today's Sale</p>
      <h4 class="font-weight-bold dark-grey-text">{{$data['todaysale']}}</h4>
    </div>
  </div>
  ...
  <div class="card-body card-body-cascade">
    ...
    @if($data['precentage'] > 0)
      <p class="card-text">Better than yesterday {{round($data['precentage'])}}%</p>
    @else
      <p class="card-text">Worse than yesterday {{round($data['precentage']*-1)}}%</p>
    @endif
  </div>
