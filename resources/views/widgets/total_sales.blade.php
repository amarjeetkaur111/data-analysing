...
<div class="card card-cascade cascading-admin-card">
  ...
  <div class="admin-up">
    ...
    <div class="data">
      <p class="text-uppercase">Yearly Sales</p>
      <h4 class="font-weight-bold dark-grey-text">{{$data['cysumtotaldollars']}}</h4>
    </div>
  </div>
  ...
  <div class="card-body card-body-cascade">
    ...
    @if($data['precentage'] < 0)
      <p class="card-text">Worse than last year {{round($data['precentage']*-1)}}%</p>
    @else
      <p class="card-text">Better than last year {{round($data['precentage'])}}%</p>
    @endif
  </div>
