...
class LastWeekTotalOrderChart extends AbstractWidget
{
    /**
    ...
    { 
        ...
        foreach($GetPharmacy as $pharmacy){
            ...
            $dollararray = count($lastweek);
            $sales[$pharmacy['PharmacyName']] = $dollararray;
        }

        return view('widgets.last_week_total_order_chart', [
            'config' => $this->config,
            'sales' => $sales,
        ]);
    }
